...
class PostgresDatabase(Database):
    ...
    def __init__(self, url: str, user: str, password: str):
        self.__connection = psycopg2.connect(url, user=user, password=password)
    ...
    def on_job_done(self, job: BaseJob, result: List[TweetCandidate]) -> None:
        ...
        self.__cursor.execute(
            f"INSERT INTO seen_posts (post_id, found_tweet) VALUES ('{submission_id}', '{tweet_link}');"
        )
