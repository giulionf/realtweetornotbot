...
class Logger:
    ...
    def log_fetch_count(fetch_count):
        ...
        print(
            "<FETCHED POSTS> {} new posts. Dispatching workers!\n".format(fetch_count)
        )
    ...
    def log_summon_count(fetch_count):
        ...
        print(
            "<FETCHED SUMMONS> {} new summons. Dispatching workers!\n".format(
                fetch_count
            )
        )
    ...
    def log_tweet_found(post_id, image_url):
        ...
        print(
            "<WORKER-{} - FOUND TWEET>\nPost: https://www.reddit.com/{}\nTweet: {}\n".format(
                threading.currentThread().getName(), post_id, image_url
            )
        )
    ...
    def log_dispatching_threads(producer_count, consumer_count):
        ...
        print(
            "<MAIN THREAD> Starting: Producers ({}) and Consumers ({})\n".format(
